...
public:
    ...
    // before disposing of the previous result.

    // Please be careful here with the memory ownership. 
    // Once you call GetProduct the user of this function is responsible to release this memory. 
...
void ClientCode(Director& director)
{
    ...
    // Once GetProduct() is called the user of this function is responsible to release the memory
    delete p; 
